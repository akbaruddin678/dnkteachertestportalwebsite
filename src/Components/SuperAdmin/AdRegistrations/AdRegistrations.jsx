  ...
  const handleFetchAndRegisterFromPortal = async () => {
    try {
      ...
      for (const record of remoteList) {
        ...
        if (r?.testMark < 20) {
          skipped.push({ cnic: a.cnic, reason: `Total marks ${total} < 30` });
          continue;
        }
                ...
                <div style={styles.formGroup}>
                  ...
                  <div style={styles.fileUpload}>
                    ...
                    <button
                      ...
                      disabled={loading}
                      title="Fetch applicants from portal and register them as students"
                    >
                      {loading
                        ? "Processing..."
                        : "Fetch & Register from Portal"}
  ...
  return (
    <>
      ...
      <div style={styles.registrationsContainer}>
        <div style={styles.registrationsHeader}>
